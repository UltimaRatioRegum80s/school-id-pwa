...
export default function StudentsPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background pb-20 md:pb-6">
      ...
      {/* Mobile: single-panel, push to profile on selection */}
...
function StudentProfilePanel({ id, onClose }: { id: number; onClose: () => void }) {
  ...
  return <StudentProfileContent data={data} id={id} onBack={onClose} />;
}
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="max-w-lg mx-auto w-full pb-4">
        <StudentProfileContent data={data} id={id} onBack={onBack} />
      </div>
    </div>
  );
}
...
function StudentProfileContent({
  ...
  data: ReturnType<typeof useGetStudent>["data"] & object;
  id: number;
  onBack: () => void;
}) {
  return (
    <div className="px-4 py-4 space-y-4" data-testid="panel-student-profile-content">
